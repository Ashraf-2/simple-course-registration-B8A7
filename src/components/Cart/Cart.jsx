...
const Cart = ({selectedCourse,totalPrice,remainingCrHr,totalCrHr}) => {
    ...
    return (
        <div className="bg-[#FFF] py-2 pl-5 rounded-xl">
            <h1 className="text-[#2F80ED] text-lg mb-4 font-bold">Credit Hour Remaining {remainingCrHr} hr</h1>
            ...
            <h4 className="text-base font-medium">Total Credit Hour:{totalCrHr} </h4>
            <hr className="border-b-2 mr-24 my-2 " />
            <h4 className="text-base font-medium mb-3">Total Price: {totalPrice} USD</h4>
        </div>
    );
};
